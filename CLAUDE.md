...
GPIO8  → DEAD — stuck HIGH (RP1 chip hardware: SPI0 CE0 idles HIGH internally — unfixable)
GPIO9  → DEAD — stuck HIGH (RP1 chip hardware: SPI0 MISO idles HIGH internally — unfixable)
